/**
In React, write a component that displays a clue with a input space to solve it with the following features:
- The component should accept props for the full set of clues and answers.
...
import { CollectionPlayerProps } from './CollectionPlayerProps';
...
function CollectionPlayer(props: CollectionPlayerProps) {
  // --- State Management ---
